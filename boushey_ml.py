...
### Boushey 2016 SVM (No Optimization)
...
# Save metrics to file
with open("figures/boushey2016/unoptimized_svm_boushey.txt", "w") as f:
    f.write(f"F1 Macro Score: {f1_macro}\n")
    f.write(f"Balanced Accuracy Score: {balanced_acc}\n")
    f.write("Classification Report:\n")
    f.write(report)
...
plt.legend()
plt.grid(True)
plt.savefig('figures/boushey2016/unoptimized_svm_boushey.png', dpi = 300, bbox_inches = 'tight')
plt.show()

#--------------------------------------------------------------------------------------------------------

### Boushey 2016 SVM (Optimized)
...
# Save metrics to file
with open("figures/boushey2016/optimized_svm_boushey.txt", "w") as f:
    f.write(f"Best Parameters Found: {bayes_search.best_params_}\n")
    f.write(f"F1 Macro Score: {f1_macro}\n")
    f.write(f"Balanced Accuracy Score: {balanced_acc}\n")
    f.write("Classification Report:\n")
...
plt.legend()
plt.grid(True)
plt.savefig('figures/boushey2016/optimized_svm_boushey.png', dpi = 300, bbox_inches = 'tight')
plt.show()