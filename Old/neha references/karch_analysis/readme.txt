The files in this directory can be used to reproduce the results of the Karch (2016) replication. The directory structure is organized as follows. 
...
3. replication_data: contains original replication data from Karch (2016).
...
1. replication.R: just runs neha on the Karch (2016) replication data. This should run in less than 1hr.

2. out_of_sample.R: runs the leave-one-policy-out prediction experiments. Takes 12-24hrs based on the system.

3. simulation.R: runs the simulation study. Takes around 36-48 hours based on the system.
