...
save(list=c("neha_karch_train","data_train"),file=paste("./output_data/karch_oos_subset_results",g,".RData",sep=""))
     ...
     save(list=c("test_data","peha.test","neha.test","neha.test.s"),file=paste("./output_data/karch_subset_oos_predict",g,".RData",sep=""))
...
save(list=c("testy","neha_scorey","peha_scorey","neha_scorey_s"),file="./output_data/karch_oos_results.RData")
