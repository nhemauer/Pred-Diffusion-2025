...
rf_model = RandomForestClassifier(
    bootstrap = True,
    ccp_alpha = 00.006076491497524607,
    class_weight = None,
    criterion = 'log_loss',
    max_depth = 12,
...
top_features_rf = importance_df.sort_values(by = 'rf_importance', ascending = False).head(6)['feature'].tolist()
...
top_features_xgb = importance_df.sort_values(by = 'xgb_importance', ascending = False).head(6)['feature'].tolist()
