...
os.chdir("ml_hyperparameter/ml_hyperparameter_prune")

### Save Outputs

with open("figures/mallinson_lovell2022/xgb_hyperparameter_results.txt", "w") as f:
...
with open("figures/mallinson_lovell2022/rf_hyperparameter_results.txt", "w") as f:
    f.write("F-test results:\n")
    f.write(str(ftest_df))
    f.write("\n\n")
