...
with open("figures/mallinson2019/optimized_logit_mallinson_threshold.txt", "w") as f:
...
plt.legend()
plt.grid(True)
plt.savefig('figures/mallinson2019/optimized_logit_mallinson_threshold.png', dpi = 300, bbox_inches = 'tight')
plt.show()
...
# Save metrics to file
with open("figures/mallinson2019/optimized_reglogit_mallinson_threshold.txt", "w") as f:
    f.write(f"Optimal Threshold: {best_threshold:.2f}\n")
    f.write(f"F1 Score: {f1}\n")
    f.write(f"Balanced Accuracy Score: {balanced_acc}\n")
    f.write("Classification Report:\n")
...
plt.legend()
plt.grid(True)
plt.savefig('figures/mallinson2019/optimized_reglogit_mallinson_threshold.png', dpi = 300, bbox_inches = 'tight')
plt.show()
...
# Save metrics to file
with open("figures/mallinson2019/optimized_rf_mallinson_threshold.txt", "w") as f:
    f.write(f"Optimal Threshold: {best_threshold:.2f}\n")
    f.write(f"F1 Score: {f1}\n")
    f.write(f"Balanced Accuracy Score: {balanced_acc}\n")
    f.write("Classification Report:\n")
...
plt.legend()
plt.grid(True)
plt.savefig('figures/mallinson2019/optimized_rf_mallinson_threshold.png', dpi = 300, bbox_inches = 'tight')
plt.show()
...
# Save metrics to file
with open("figures/mallinson2019/optimized_xgb_mallinson_threshold.txt", "w") as f:
    f.write(f"Optimal Threshold: {best_threshold:.2f}\n")
    f.write(f"F1 Score: {f1}\n")
    f.write(f"Balanced Accuracy Score: {balanced_acc}\n")
    f.write("Classification Report:\n")
...
plt.legend()
plt.grid(True)
plt.savefig('figures/mallinson2019/optimized_xgb_mallinson_threshold.png', dpi = 300, bbox_inches = 'tight')
plt.show()