...
unique_styears = sorted(mallinson_2019['year'].unique())
...
# Split data by 50/50
splits = {
    'First_50': mallinson_2019[mallinson_2019['year'].isin(first_50_styears)],
    'Last_50': mallinson_2019[mallinson_2019['year'].isin(last_50_styears)],
    'Full_Dataset': mallinson_2019
}
...
plt.tight_layout()
plt.savefig('figures/mallinson2019/mallinson_coef_comparison.png', dpi = 300, bbox_inches = 'tight')
plt.show()
