...
unique_styears = sorted(karch_2016['year'].unique())
...
# Split data by 50/50
splits = {
    'First_50': karch_2016[karch_2016['year'].isin(first_50_styears)],
    'Last_50': karch_2016[karch_2016['year'].isin(last_50_styears)],
    'Full_Dataset': karch_2016
}
...
plt.tight_layout()
plt.savefig('figures/karch2016/karch_coef_comparison.png', dpi = 300, bbox_inches = 'tight')
plt.show()
