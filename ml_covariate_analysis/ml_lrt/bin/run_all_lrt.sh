...
for script in /storage/work/ndh5286/Projects/Pred_Diffusion_2025/ml_covariate_analysis/ml_lrt/*.py; do
...
#SBATCH --output=ml_covariate_analysis/ml_lrt/logs/%x_%j.out
