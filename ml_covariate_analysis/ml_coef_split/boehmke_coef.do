...
* Create dummy variables for state (excluding one)
...
graph export "ml_covariate_analysis/ml_coef_split/figures/boehmke2017/boehmke_coefplot_split.png", replace width(2000)