    ...
    for policy in test_policies:
        ...
        for state in policy_data['state'].unique():
            ...
            for extension in range(max_extensions):
                ...
                hazards = xgb_model.predict_proba(X_state_policy_scaled)[:, 1]
...
results_df.to_csv("figures/kreitzer_boehmke2016/kreitzer_boehmke_cdf_results_xgb.csv", index = False)
...
with open('figures/kreitzer_boehmke2016/kreitzer_boehmke_maef1_xgb.txt', 'w') as f:
