...
results_df.to_csv("figures/bricker_lacombe2021/bricker_lacombe_cdf_results_xgb.csv", index = False)
...
with open('figures/bricker_lacombe2021/bricker_lacombe_maef1_xgb.txt', 'w') as f:
