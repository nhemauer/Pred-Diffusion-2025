...
results_df.to_csv("figures/bricker_lacombe2021/bricker_lacombe_cdf_results_logit.csv", index = False)
...
with open('figures/bricker_lacombe2021/bricker_lacombe_maef1_logit.txt', 'w') as f:
