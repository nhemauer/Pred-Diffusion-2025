...
results_df.to_csv("figures/kreitzer_boehmke2016/kreitzer_boehmke_cdf_results_rf.csv", index = False)
...
with open('figures/kreitzer_boehmke2016/kreitzer_boehmke_maef1_rf.txt', 'w') as f:
