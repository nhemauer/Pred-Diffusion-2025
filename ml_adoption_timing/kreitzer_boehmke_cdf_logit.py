...
results_df.to_csv("figures/kreitzer_boehmke2016/kreitzer_boehmke_cdf_results_logit.csv", index = False)
...
with open('figures/kreitzer_boehmke2016/kreitzer_boehmke_maef1_logit.txt', 'w') as f:
