...
results_df.to_csv("figures/lacombe_boehmke2021/lacombe_boehmke_cdf_results_xgb.csv", index = False)
...
with open('figures/lacombe_boehmke2021/lacombe_boehmke_maef1_xgb.txt', 'w') as f:
