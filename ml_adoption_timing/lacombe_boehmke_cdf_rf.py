...
results_df.to_csv("figures/lacombe_boehmke2021/lacombe_boehmke_cdf_results_rf.csv", index = False)
...
with open('figures/lacombe_boehmke2021/lacombe_boehmke_maef1_rf.txt', 'w') as f:
