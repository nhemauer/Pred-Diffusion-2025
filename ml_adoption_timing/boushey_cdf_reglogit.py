...
# Define X and y
X_full = boushey_2016[covariates].copy()
y_full = boushey_2016['dvadopt'].copy()
...
results_df.to_csv("figures/boushey2016/boushey_cdf_results_reglogit.csv", index = False)
...
with open('figures/boushey2016/boushey_maef1_reglogit.txt', 'w') as f:
