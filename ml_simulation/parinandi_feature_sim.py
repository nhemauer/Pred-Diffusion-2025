...
# Data
parinandi2020_full = pd.read_csv(r"figures/parinandi2020/parinandi_sim_data.csv")
...
parinandi2020 = parinandi2020_full[["event"] + covariates].dropna()
...
# Define X and y
X = parinandi2020.drop(columns = ['event']).copy()
y = parinandi2020['event']
