...
# Data
karch_2016_full = pd.read_csv(r"figures/karch2016/karch_sim_data.csv")
...
karch_2016 = karch_2016_full[["event", "billnum"] + covariates].dropna()
...
plt.tight_layout()
plt.savefig('figures/karch2016/karch_partial_dependence_rf.png', dpi = 300, bbox_inches = 'tight')
plt.show()
...
plt.tight_layout()
plt.savefig('figures/karch2016/karch_partial_dependence_xgb.png', dpi = 300, bbox_inches = 'tight')
plt.show()