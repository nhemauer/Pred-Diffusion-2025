...
unique_states = lacombe_boehmke2021['state'].unique()
...
# Save to CSV
results_df.to_csv(f'figures/lacombe_boehmke2021/state_files/lacombe_state_results_xgb_{state_idx}.csv', index = False)