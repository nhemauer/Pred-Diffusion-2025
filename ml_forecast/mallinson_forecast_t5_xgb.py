...
with open("figures/mallinson2019/t5_forecast_results_xgb.txt", "w") as f:
    for model in ['xgb']:
        f.write(f"\n{model.upper()} Results:\n")
...
plt.tight_layout()
plt.savefig('figures/mallinson2019/t5_forecast_timeseries_xgb.png', dpi = 300, bbox_inches = 'tight')
plt.show()
...
time_series_results.to_csv('figures/mallinson2019/t5_forecast_timeseries_xgb.csv', index = False)