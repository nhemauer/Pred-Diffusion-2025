...
with open("figures/mallinson2019/t10_forecast_results_logit.txt", "w") as f:
...
plt.tight_layout()
plt.savefig('figures/mallinson2019/t10_forecast_timeseries_logit.png', dpi = 300, bbox_inches = 'tight')
plt.show()
...
time_series_results.to_csv('figures/mallinson2019/t10_forecast_timeseries_logit.csv', index = False)