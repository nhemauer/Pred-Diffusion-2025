...
with open("figures/lacombe_boehmke2021/t5_forecast_results_logrf.txt", "w") as f:
...
plt.tight_layout()
plt.savefig('figures/lacombe_boehmke2021/t5_forecast_timeseries_logrf.png', dpi = 300, bbox_inches = 'tight')
plt.show()
...
time_series_results.to_csv('figures/lacombe_boehmke2021/t5_forecast_timeseries_logrf.csv', index = False)