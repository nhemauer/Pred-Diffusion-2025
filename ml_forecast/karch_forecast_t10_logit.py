...
with open("figures/karch2016/t10_forecast_results_logit.txt", "w") as f:
...
plt.tight_layout()
plt.savefig('figures/karch2016/t10_forecast_timeseries_logit.png', dpi = 300, bbox_inches = 'tight')
plt.show()
...
time_series_results.to_csv('figures/karch2016/t10_forecast_timeseries_logit.csv', index = False)