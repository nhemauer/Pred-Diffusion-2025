...
- The '_processed.csv' files in 'data/ are the same STATA dataframes, but are either altered to be '.csv', have a column name change, or have character values converted to numeric' 
